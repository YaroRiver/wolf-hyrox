...
| 2026-08-25 | W35 TUE | Deload / Gate 1 week | 202 kg | 2×20 m | 67 / 61 sec | 2:00 rest, consistent setup both sets. Second-set improvement again supports a first-set rhythm/setup cost, not a strength issue. **Master Plan v2.3 correction: current Men Pro race load is 153kg including sled — 202kg is ~32% above race weight.** First-set penalty is confirmed only at this heavy training load; race-load behavior is unproven. W38 tests both loads paired in the same session before classifying this as race-specific. |
| 2026-09-01 | W36 TUE | Melbourne Phase II W1 | 202 kg | 3×20 m | **1:23 / 1:05 / 0:55** | First-set penalty widened to 28 sec (vs 21 sec, W34), but **Set 3 (0:55) is a new best single-set time at working load, beating the prior 0:59 (W34).** Confirms the first-set cost is a setup/rhythm component, not a strength ceiling — S2/S3 keep improving independent of S1. From `HYROX_W36_FULL_REPORTS` athlete pack, 2026-09-06. |
